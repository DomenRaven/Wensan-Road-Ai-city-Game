...
MANIFEST_PATH: Path = REPO_ROOT / "config" / "frozen_genre_platformer.json"
SNAPSHOT_ROOT: Path = (
    REPO_ROOT / "开发文档" / "模板引擎" / "快照" / "frozen" / "6.24_platformer_v1.0"
)

GENRE: str = "platformer"
EDU_HOOKS: tuple[str, ...] = ("platformer_hooks.gd",)
...
def build_manifest() -> dict[str, object]:
    ...
    return {
        ...
        "shared_association": [
            "kiosk/edu/edu-wizard.js · getGenreHighlightFallback().platformer",
            "kiosk/edu/edu-wizard.js · renderB7DemoActionsHtml platformer 默认演示钮",
        ],
        "files": files,
    }
...
def verify_manifest() -> int:
    ...
    print(f"OK · {count} frozen platformer files match manifest")
    return 0
...
def main() -> int:
    ...
    print("Usage: freeze_platformer_snapshot.py [write|verify]")
    return 2
