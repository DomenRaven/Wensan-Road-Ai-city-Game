extends RefCounted
class_name PowerSmashSkill

## Prefabricated skill — next paddle hit applies speed boost (wired in ball.gd)
...
static func is_enabled() -> bool:
	return GameConfig.has_skill("power_smash")


static func get_cooldown_sec() -> float:
	return BASE_COOLDOWN_SEC * GameConfig.get_skill_cooldown_scale("power_smash")
