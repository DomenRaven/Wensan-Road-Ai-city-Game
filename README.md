...
> **版本**：**1.1**（见 [`VERSION`](VERSION) · [`CHANGELOG.md`](CHANGELOG.md) · tag **`v1.1`**）  
> **GitHub**：https://github.com/DomenRaven/Wensan-Road-Ai-city-Game  
> **部署**：[`开发文档/部署手册_v1.1.md`](开发文档/部署手册_v1.1.md)  
> **状态快照**：[`开发文档/模板引擎/快照/6.26_P3_收工后状态快照_v1.0.md`](开发文档/模板引擎/快照/6.26_P3_收工后状态快照_v1.0.md)
...
| 入口 | URL | 用途 |
|------|-----|------|
| A 链快玩 | http://127.0.0.1:8080/kiosk/ | 7 款游戏快体验 |
| B 链教育版 | http://127.0.0.1:8080/kiosk/edu/ | 创作 → 制作 → 试玩全链 |
| API 文档 | http://127.0.0.1:8000/docs | FastAPI |

**环境**：Godot **4.6** · Python 3.11+ · 详见 [`开发文档/部署手册_v1.1.md`](开发文档/部署手册_v1.1.md)
...
| 目录 | 说明 |
|------|------|
| `templates/` | **7 款** Godot 游戏模板（`core/` 预制，用户改 `config/game_config.json`） |
...
- 当前发布：**v1.1**（标签 `v1.1`）
- 回退：`git checkout v1.0` 或 `git checkout v1.1`
...
- [**项目方案 v1.1**](开发文档/项目方案_v1.1.md)（功能 · 架构 · 用户流程）
- [**部署手册 v1.1**](开发文档/部署手册_v1.1.md)
- [**甲方 P3 升级方案（v1.1 交付核对）**](开发文档/模板引擎/6.26_甲方升级方案与LLM评估_v1.0.md)
