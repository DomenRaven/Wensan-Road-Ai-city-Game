...
> **服务器 AI 自动部署**：[`开发文档/服务器部署_AI智能体自动部署手册_v1.3.md`](开发文档/服务器部署_AI智能体自动部署手册_v1.3.md)（**二维码未实装，须服务器 Agent 补齐**）  
> **操作说明书**：[`开发文档/软件操作说明书_v1.2.md`](开发文档/软件操作说明书_v1.2.md)  
> **部署手册**：[`开发文档/部署手册_v1.2.md`](开发文档/部署手册_v1.2.md)  
> **当前开发主线**：[`开发文档/工作方向锁定_AI改游戏智能体_v1.md`](开发文档/工作方向锁定_AI改游戏智能体_v1.md) · 对接 [`7.19 新窗对接`](开发文档/7.19_AI改游戏智能体_新窗对接_HF-12_Live收口_2026-07-19.md)
...
输出：`交付/GameForge-K12-v1.2-server-YYYYMMDD.zip`（含 `AI智能体自动部署手册_请先读.md`）
